...
openany % Uncomment to start chapters on any page, not just odd pages
...
\vspace{1cm}
\noindent Signed: \includegraphics[height=10em]{Figures/sig.png} \\ % Adjust the height as needed
