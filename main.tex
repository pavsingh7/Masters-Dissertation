...
\supervisor{Assoc Professor Ian \textsc{Durbach} \\
		Dr. Allan \textsc{Clark}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\subject{Advanced Analytics Masters} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
